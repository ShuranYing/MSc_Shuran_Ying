...
combined_map <- (
  d_labeled | plot_spacer() | c_labeled
) /
  (plot_spacer() | z_small | plot_spacer()) +
  plot_layout(guides = "collect", widths = c(1, 0.0005, 1), heights = c(1, 0.7)) & 
  theme(legend.position = "right")
...
combined_map <- (
  ...
  z_labeled +
  plot_layout(guides = "collect", heights = c(1, 0.7)) & 
  theme(legend.position = "right")
